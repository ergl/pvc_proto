...
encode_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
      'PutRegion' ->
	  e_msg_PutRegion(id(Msg, TrUserData), TrUserData);
      'PutRegionResp' ->
	  e_msg_PutRegionResp(id(Msg, TrUserData), TrUserData);
      'PutCategory' ->
	  e_msg_PutCategory(id(Msg, TrUserData), TrUserData);
      'PutCategoryResp' ->
	  e_msg_PutCategoryResp(id(Msg, TrUserData), TrUserData);
      'AuthUser' ->
	  e_msg_AuthUser(id(Msg, TrUserData), TrUserData);
      'AuthUserResp' ->
	  e_msg_AuthUserResp(id(Msg, TrUserData), TrUserData);
      'RegisterUser' ->
	  e_msg_RegisterUser(id(Msg, TrUserData), TrUserData);
      'RegisterUserResp' ->
	  e_msg_RegisterUserResp(id(Msg, TrUserData), TrUserData);
      'BrowseCategories' ->
	  e_msg_BrowseCategories(id(Msg, TrUserData), TrUserData);
      'BrowseCategoriesResp' ->
	  e_msg_BrowseCategoriesResp(id(Msg, TrUserData),
				     TrUserData);
      'BrowseRegions' ->
	  e_msg_BrowseRegions(id(Msg, TrUserData), TrUserData);
      'BrowseRegionsResp' ->
	  e_msg_BrowseRegionsResp(id(Msg, TrUserData),
				  TrUserData);
      'SearchByCategory' ->
	  e_msg_SearchByCategory(id(Msg, TrUserData), TrUserData);
      'SearchByCategoryResp' ->
	  e_msg_SearchByCategoryResp(id(Msg, TrUserData),
				     TrUserData);
      'SearchByRegion' ->
	  e_msg_SearchByRegion(id(Msg, TrUserData), TrUserData);
      'SearchByRegionResp' ->
	  e_msg_SearchByRegionResp(id(Msg, TrUserData),
				   TrUserData);
      'ViewItem' ->
	  e_msg_ViewItem(id(Msg, TrUserData), TrUserData);
      'ViewItemResp' ->
	  e_msg_ViewItemResp(id(Msg, TrUserData), TrUserData);
      'ViewUser' ->
	  e_msg_ViewUser(id(Msg, TrUserData), TrUserData);
      'ViewUserResp' ->
	  e_msg_ViewUserResp(id(Msg, TrUserData), TrUserData);
      'ViewItemBidHist' ->
	  e_msg_ViewItemBidHist(id(Msg, TrUserData), TrUserData);
      'ViewItemBidHistResp' ->
	  e_msg_ViewItemBidHistResp(id(Msg, TrUserData),
				    TrUserData);
      'StoreBuyNow' ->
	  e_msg_StoreBuyNow(id(Msg, TrUserData), TrUserData);
      'StoreBuyNowResp' ->
	  e_msg_StoreBuyNowResp(id(Msg, TrUserData), TrUserData);
      'StoreBid' ->
	  e_msg_StoreBid(id(Msg, TrUserData), TrUserData);
      'StoreBidResp' ->
	  e_msg_StoreBidResp(id(Msg, TrUserData), TrUserData);
      'StoreComment' ->
	  e_msg_StoreComment(id(Msg, TrUserData), TrUserData);
      'StoreCommentResp' ->
	  e_msg_StoreCommentResp(id(Msg, TrUserData), TrUserData);
      'StoreItem' ->
	  e_msg_StoreItem(id(Msg, TrUserData), TrUserData);
      'StoreItemResp' ->
	  e_msg_StoreItemResp(id(Msg, TrUserData), TrUserData);
      'AboutMe' ->
	  e_msg_AboutMe(id(Msg, TrUserData), TrUserData);
      'AboutMeResp' ->
	  e_msg_AboutMeResp(id(Msg, TrUserData), TrUserData)
    end.
...
e_msg_StoreComment(#{} = M, Bin, TrUserData) ->
    ...
    B4 = case M of
	   #{rating := F4} ->
		 ...
		 if TrF4 =:= 0 -> B3;
		    true ->
			e_type_sfixed32(TrF4, <<B3/binary, 37>>, TrUserData)
		 end
	       end;
	   _ -> B3
	 end,
...
decode_msg_2_doit('PutRegion', Bin, TrUserData) ->
    id(d_msg_PutRegion(Bin, TrUserData), TrUserData);
decode_msg_2_doit('PutRegionResp', Bin, TrUserData) ->
    id(d_msg_PutRegionResp(Bin, TrUserData), TrUserData);
decode_msg_2_doit('PutCategory', Bin, TrUserData) ->
    id(d_msg_PutCategory(Bin, TrUserData), TrUserData);
decode_msg_2_doit('PutCategoryResp', Bin, TrUserData) ->
    id(d_msg_PutCategoryResp(Bin, TrUserData), TrUserData);
decode_msg_2_doit('AuthUser', Bin, TrUserData) ->
    id(d_msg_AuthUser(Bin, TrUserData), TrUserData);
decode_msg_2_doit('AuthUserResp', Bin, TrUserData) ->
    id(d_msg_AuthUserResp(Bin, TrUserData), TrUserData);
decode_msg_2_doit('RegisterUser', Bin, TrUserData) ->
    id(d_msg_RegisterUser(Bin, TrUserData), TrUserData);
decode_msg_2_doit('RegisterUserResp', Bin,
		  TrUserData) ->
    id(d_msg_RegisterUserResp(Bin, TrUserData), TrUserData);
decode_msg_2_doit('BrowseCategories', Bin,
		  TrUserData) ->
    id(d_msg_BrowseCategories(Bin, TrUserData), TrUserData);
decode_msg_2_doit('BrowseCategoriesResp', Bin,
		  TrUserData) ->
    id(d_msg_BrowseCategoriesResp(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit('BrowseRegions', Bin, TrUserData) ->
    id(d_msg_BrowseRegions(Bin, TrUserData), TrUserData);
decode_msg_2_doit('BrowseRegionsResp', Bin,
		  TrUserData) ->
    id(d_msg_BrowseRegionsResp(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit('SearchByCategory', Bin,
		  TrUserData) ->
    id(d_msg_SearchByCategory(Bin, TrUserData), TrUserData);
decode_msg_2_doit('SearchByCategoryResp', Bin,
		  TrUserData) ->
    id(d_msg_SearchByCategoryResp(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit('SearchByRegion', Bin, TrUserData) ->
    id(d_msg_SearchByRegion(Bin, TrUserData), TrUserData);
decode_msg_2_doit('SearchByRegionResp', Bin,
		  TrUserData) ->
    id(d_msg_SearchByRegionResp(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit('ViewItem', Bin, TrUserData) ->
    id(d_msg_ViewItem(Bin, TrUserData), TrUserData);
decode_msg_2_doit('ViewItemResp', Bin, TrUserData) ->
    id(d_msg_ViewItemResp(Bin, TrUserData), TrUserData);
decode_msg_2_doit('ViewUser', Bin, TrUserData) ->
    id(d_msg_ViewUser(Bin, TrUserData), TrUserData);
decode_msg_2_doit('ViewUserResp', Bin, TrUserData) ->
    id(d_msg_ViewUserResp(Bin, TrUserData), TrUserData);
decode_msg_2_doit('ViewItemBidHist', Bin, TrUserData) ->
    id(d_msg_ViewItemBidHist(Bin, TrUserData), TrUserData);
decode_msg_2_doit('ViewItemBidHistResp', Bin,
		  TrUserData) ->
    id(d_msg_ViewItemBidHistResp(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit('StoreBuyNow', Bin, TrUserData) ->
    id(d_msg_StoreBuyNow(Bin, TrUserData), TrUserData);
decode_msg_2_doit('StoreBuyNowResp', Bin, TrUserData) ->
    id(d_msg_StoreBuyNowResp(Bin, TrUserData), TrUserData);
decode_msg_2_doit('StoreBid', Bin, TrUserData) ->
    id(d_msg_StoreBid(Bin, TrUserData), TrUserData);
decode_msg_2_doit('StoreBidResp', Bin, TrUserData) ->
    id(d_msg_StoreBidResp(Bin, TrUserData), TrUserData);
decode_msg_2_doit('StoreComment', Bin, TrUserData) ->
    id(d_msg_StoreComment(Bin, TrUserData), TrUserData);
decode_msg_2_doit('StoreCommentResp', Bin,
		  TrUserData) ->
    id(d_msg_StoreCommentResp(Bin, TrUserData), TrUserData);
decode_msg_2_doit('StoreItem', Bin, TrUserData) ->
    id(d_msg_StoreItem(Bin, TrUserData), TrUserData);
decode_msg_2_doit('StoreItemResp', Bin, TrUserData) ->
    id(d_msg_StoreItemResp(Bin, TrUserData), TrUserData);
decode_msg_2_doit('AboutMe', Bin, TrUserData) ->
    id(d_msg_AboutMe(Bin, TrUserData), TrUserData);
decode_msg_2_doit('AboutMeResp', Bin, TrUserData) ->
    id(d_msg_AboutMeResp(Bin, TrUserData), TrUserData).
...
d_field_PutRegionResp_region_id(<<0:1, X:7,
    ...
    dfp_read_field_def_PutRegionResp(RestF, 0, 0,
				     id({region_id, NewFValue}, TrUserData),
				     TrUserData).
...
d_field_PutCategoryResp_category_id(<<0:1, X:7,
    ...
    dfp_read_field_def_PutCategoryResp(RestF, 0, 0,
				       id({category_id, NewFValue}, TrUserData),
				       TrUserData).
...
d_field_AuthUserResp_user_id(<<0:1, X:7, Rest/binary>>,
    ...
    dfp_read_field_def_AuthUserResp(RestF, 0, 0,
				    id({user_id, NewFValue}, TrUserData),
				    TrUserData).
...
dfp_read_field_def_SearchByRegion(<<>>, 0, 0, F@_1,
				  F@_2, _) ->
    #{category_id => F@_1, region_id => F@_2};
...
d_field_StoreBuyNowResp_buy_now_id(<<0:1, X:7,
    ...
    dfp_read_field_def_StoreBuyNowResp(RestF, 0, 0,
				       id({buy_now_id, NewFValue}, TrUserData),
				       TrUserData).
...
dfp_read_field_def_StoreBid(<<>>, 0, 0, F@_1, F@_2,
			    F@_3, _) ->
    #{on_item_id => F@_1, bidder_id => F@_2, value => F@_3};
...
d_field_StoreBidResp_bid_id(<<0:1, X:7, Rest/binary>>,
    ...
    dfp_read_field_def_StoreBidResp(RestF, 0, 0,
				    id({bid_id, NewFValue}, TrUserData),
				    TrUserData).
...
dfp_read_field_def_StoreComment(<<>>, 0, 0, F@_1, F@_2,
				F@_3, F@_4, F@_5, _) ->
    #{on_item_id => F@_1, from_id => F@_2, to_id => F@_3,
      rating => F@_4, body => F@_5};
...
d_field_StoreComment_rating(<<Value:32/little-signed,
    ...
    dfp_read_field_def_StoreComment(Rest, Z1, Z2, F@_1,
				    F@_2, F@_3, id(Value, TrUserData), F@_5,
				    TrUserData).
...
d_field_StoreCommentResp_comment_id(<<0:1, X:7,
    ...
    dfp_read_field_def_StoreCommentResp(RestF, 0, 0,
					id({comment_id, NewFValue}, TrUserData),
					TrUserData).
...
dfp_read_field_def_StoreItem(<<>>, 0, 0, F@_1, F@_2,
			     F@_3, F@_4, F@_5, _) ->
    #{item_name => F@_1, description => F@_2,
      quantity => F@_3, category_id => F@_4,
      seller_id => F@_5};
...
d_field_StoreItemResp_item_id(<<0:1, X:7, Rest/binary>>,
    ...
    dfp_read_field_def_StoreItemResp(RestF, 0, 0,
				     id({item_id, NewFValue}, TrUserData),
				     TrUserData).
...
verify_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
      'PutRegion' ->
	  v_msg_PutRegion(Msg, [MsgName], TrUserData);
      'PutRegionResp' ->
	  v_msg_PutRegionResp(Msg, [MsgName], TrUserData);
      'PutCategory' ->
	  v_msg_PutCategory(Msg, [MsgName], TrUserData);
      'PutCategoryResp' ->
	  v_msg_PutCategoryResp(Msg, [MsgName], TrUserData);
      'AuthUser' ->
	  v_msg_AuthUser(Msg, [MsgName], TrUserData);
      'AuthUserResp' ->
	  v_msg_AuthUserResp(Msg, [MsgName], TrUserData);
      'RegisterUser' ->
	  v_msg_RegisterUser(Msg, [MsgName], TrUserData);
      'RegisterUserResp' ->
	  v_msg_RegisterUserResp(Msg, [MsgName], TrUserData);
      'BrowseCategories' ->
	  v_msg_BrowseCategories(Msg, [MsgName], TrUserData);
      'BrowseCategoriesResp' ->
	  v_msg_BrowseCategoriesResp(Msg, [MsgName], TrUserData);
      'BrowseRegions' ->
	  v_msg_BrowseRegions(Msg, [MsgName], TrUserData);
      'BrowseRegionsResp' ->
	  v_msg_BrowseRegionsResp(Msg, [MsgName], TrUserData);
      'SearchByCategory' ->
	  v_msg_SearchByCategory(Msg, [MsgName], TrUserData);
      'SearchByCategoryResp' ->
	  v_msg_SearchByCategoryResp(Msg, [MsgName], TrUserData);
      'SearchByRegion' ->
	  v_msg_SearchByRegion(Msg, [MsgName], TrUserData);
      'SearchByRegionResp' ->
	  v_msg_SearchByRegionResp(Msg, [MsgName], TrUserData);
      'ViewItem' ->
	  v_msg_ViewItem(Msg, [MsgName], TrUserData);
      'ViewItemResp' ->
	  v_msg_ViewItemResp(Msg, [MsgName], TrUserData);
      'ViewUser' ->
	  v_msg_ViewUser(Msg, [MsgName], TrUserData);
      'ViewUserResp' ->
	  v_msg_ViewUserResp(Msg, [MsgName], TrUserData);
      'ViewItemBidHist' ->
	  v_msg_ViewItemBidHist(Msg, [MsgName], TrUserData);
      'ViewItemBidHistResp' ->
	  v_msg_ViewItemBidHistResp(Msg, [MsgName], TrUserData);
      'StoreBuyNow' ->
	  v_msg_StoreBuyNow(Msg, [MsgName], TrUserData);
      'StoreBuyNowResp' ->
	  v_msg_StoreBuyNowResp(Msg, [MsgName], TrUserData);
      'StoreBid' ->
	  v_msg_StoreBid(Msg, [MsgName], TrUserData);
      'StoreBidResp' ->
	  v_msg_StoreBidResp(Msg, [MsgName], TrUserData);
      'StoreComment' ->
	  v_msg_StoreComment(Msg, [MsgName], TrUserData);
      'StoreCommentResp' ->
	  v_msg_StoreCommentResp(Msg, [MsgName], TrUserData);
      'StoreItem' ->
	  v_msg_StoreItem(Msg, [MsgName], TrUserData);
      'StoreItemResp' ->
	  v_msg_StoreItemResp(Msg, [MsgName], TrUserData);
      'AboutMe' -> v_msg_AboutMe(Msg, [MsgName], TrUserData);
      'AboutMeResp' ->
	  v_msg_AboutMeResp(Msg, [MsgName], TrUserData);
...
v_msg_PutRegion(#{} = M, Path, TrUserData) ->
    case M of
      #{region_name := F1} ->
	  v_type_bytes(F1, [region_name | Path], TrUserData);
      _ -> ok
    end,
...
v_msg_PutRegionResp(#{} = M, Path, TrUserData) ->
    case M of
      #{resp := {region_id, OF1}} ->
	  v_type_bytes(OF1, [region_id, resp | Path], TrUserData);
...
v_msg_PutCategory(#{} = M, Path, TrUserData) ->
    case M of
      #{category_name := F1} ->
	  v_type_bytes(F1, [category_name | Path], TrUserData);
      _ -> ok
    end,
...
v_msg_AuthUser(#{} = M, Path, TrUserData) ->
    case M of
      #{username := F1} ->
	  v_type_bytes(F1, [username | Path], TrUserData);
      _ -> ok
    end,
    case M of
      #{password := F2} ->
...
v_msg_AuthUserResp(#{} = M, Path, TrUserData) ->
    case M of
      #{resp := {user_id, OF1}} ->
	  v_type_bytes(OF1, [user_id, resp | Path], TrUserData);
      #{resp := {error_reason, OF1}} ->
	  v_type_uint32(OF1, [error_reason, resp | Path],
			TrUserData);
      #{resp := F1} ->
...
v_msg_RegisterUser(#{} = M, Path, TrUserData) ->
    ...
    case M of
      #{region_id := F3} ->
	  v_type_bytes(F3, [region_id | Path], TrUserData);
      _ -> ok
    end,
    lists:foreach(fun (username) -> ok;
		      (password) -> ok;
...
v_msg_SearchByCategory(#{} = M, Path, TrUserData) ->
    case M of
      #{category_id := F1} ->
	  v_type_bytes(F1, [category_id | Path], TrUserData);
      _ -> ok
    end,
...
v_msg_SearchByRegion(#{} = M, Path, TrUserData) ->
    ...
    case M of
      #{region_id := F2} ->
	  v_type_bytes(F2, [region_id | Path], TrUserData);
      _ -> ok
    end,
    lists:foreach(fun (category_id) -> ok;
		      (region_id) -> ok;
...
v_msg_ViewItem(#{} = M, Path, TrUserData) ->
    case M of
      #{item_id := F1} ->
	  v_type_bytes(F1, [item_id | Path], TrUserData);
      _ -> ok
    end,
...
v_msg_ViewUser(#{} = M, Path, TrUserData) ->
    case M of
      #{user_id := F1} ->
	  v_type_bytes(F1, [user_id | Path], TrUserData);
      _ -> ok
    end,
...
v_msg_StoreBuyNow(#{} = M, Path, TrUserData) ->
    case M of
      #{on_item_id := F1} ->
	  v_type_bytes(F1, [on_item_id | Path], TrUserData);
      _ -> ok
    end,
    case M of
      #{buyer_id := F2} ->
	  v_type_bytes(F2, [buyer_id | Path], TrUserData);
      _ -> ok
    end,
    case M of
      #{quantity := F3} ->
	  v_type_uint32(F3, [quantity | Path], TrUserData);
      _ -> ok
    end,
...
v_msg_StoreBid(#{} = M, Path, TrUserData) ->
    ...
    case M of
      #{bidder_id := F2} ->
	  v_type_bytes(F2, [bidder_id | Path], TrUserData);
      _ -> ok
    end,
    case M of
      #{value := F3} ->
	  v_type_uint32(F3, [value | Path], TrUserData);
      _ -> ok
    end,
    lists:foreach(fun (on_item_id) -> ok;
		      (bidder_id) -> ok;
...
v_msg_StoreBidResp(#{} = M, Path, TrUserData) ->
    case M of
      #{resp := {bid_id, OF1}} ->
	  v_type_bytes(OF1, [bid_id, resp | Path], TrUserData);
      #{resp := {error_reason, OF1}} ->
	  v_type_uint32(OF1, [error_reason, resp | Path],
			TrUserData);
      #{resp := F1} ->
...
v_msg_StoreComment(#{} = M, Path, TrUserData) ->
    ...
    case M of
      #{from_id := F2} ->
	  v_type_bytes(F2, [from_id | Path], TrUserData);
      _ -> ok
    end,
    case M of
      #{to_id := F3} ->
	  v_type_bytes(F3, [to_id | Path], TrUserData);
      _ -> ok
    end,
    case M of
      #{rating := F4} ->
	  v_type_sfixed32(F4, [rating | Path], TrUserData);
      _ -> ok
    end,
    case M of
      #{body := F5} ->
	  v_type_bytes(F5, [body | Path], TrUserData);
      _ -> ok
    end,
    lists:foreach(fun (on_item_id) -> ok;
		      (from_id) -> ok;
...
v_msg_StoreItem(#{} = M, Path, TrUserData) ->
    case M of
      #{item_name := F1} ->
	  v_type_bytes(F1, [item_name | Path], TrUserData);
      _ -> ok
    end,
    case M of
      #{description := F2} ->
	  v_type_bytes(F2, [description | Path], TrUserData);
      _ -> ok
    end,
    case M of
      #{quantity := F3} ->
    ...
    case M of
      #{category_id := F4} ->
	  v_type_bytes(F4, [category_id | Path], TrUserData);
      _ -> ok
    end,
    case M of
      #{seller_id := F5} ->
	  v_type_bytes(F5, [seller_id | Path], TrUserData);
      _ -> ok
    end,
...
v_msg_StoreItemResp(#{} = M, Path, TrUserData) ->
    case M of
      #{resp := {item_id, OF1}} ->
	  v_type_bytes(OF1, [item_id, resp | Path], TrUserData);
      #{resp := {error_reason, OF1}} ->
	  v_type_uint32(OF1, [error_reason, resp | Path],
			TrUserData);
      #{resp := F1} ->
...
get_msg_names() ->
    ['PutRegion', 'PutRegionResp', 'PutCategory',
     'PutCategoryResp', 'AuthUser', 'AuthUserResp',
     'RegisterUser', 'RegisterUserResp', 'BrowseCategories',
     'BrowseCategoriesResp', 'BrowseRegions',
     'BrowseRegionsResp', 'SearchByCategory',
     'SearchByCategoryResp', 'SearchByRegion',
     'SearchByRegionResp', 'ViewItem', 'ViewItemResp',
     'ViewUser', 'ViewUserResp', 'ViewItemBidHist',
     'ViewItemBidHistResp', 'StoreBuyNow', 'StoreBuyNowResp',
     'StoreBid', 'StoreBidResp', 'StoreComment',
     'StoreCommentResp', 'StoreItem', 'StoreItemResp',
     'AboutMe', 'AboutMeResp'].
